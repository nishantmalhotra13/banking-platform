...
* The original package name 'banking-platform.orchestrator-auth' is invalid and this project uses 'banking_platform.orchestrator_auth' instead.
...
* [OAuth2 Authorization Server](https://docs.spring.io/spring-boot/4.1.0-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.authorization-server)
